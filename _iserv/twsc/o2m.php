<?php
	...
	$BACKUP_ORDER	= true;		
	$MERCHANT_TO	= "<73317659@continental.edu.pe>";		
	$MERCHANT_FROM	= "<73317659@continental.edu.pe>";	
	$MERCHANT_BCC 	= true;		
	$MERCHANT_DATE_FORMAT = "mm/dd/yyyy";	
	$CRLF 			= "\r\n";				
	$HTTP_PREFIX	= (false)?'https://':'http://';		
	$VO_CTR = "4238e7348d994eb3362bc63e361eedfa";					
	$MAX_PERIOD = -1;				
	$ORDER_EMAIL_ADD_URL = false;		
	$ACCOUNTS_URL = "";
	$COOKIE_ACCOUNT_INF = "5288-account_inf";
